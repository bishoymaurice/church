...
public class YearOrg implements Serializable {
	...
	public GridLayout getLayout() {
		...
		MenuItem addMenuItem = settingItems.addItem(" ÃœÌœ", newYearCommand);
		addMenuItem.setIcon(FontAwesome.PLUS_CIRCLE);

		MenuItem editMenuItem = settingItems.addItem("  ⁄œÌ·", updateYearCommand);
		editMenuItem.setIcon(FontAwesome.EDIT);

		MenuItem deleteMenuItem = settingItems.addItem(" Õ–›", deleteYearCommand);
		deleteMenuItem.setIcon(FontAwesome.TRASH_O);

		settingItems.addSeparator();

		MenuItem assignFamilyMenuItem = settingItems.addItem("  ⁄ÌÌ‰ ›’·", assignClassCommand);
