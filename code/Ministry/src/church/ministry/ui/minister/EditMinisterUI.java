...
public class EditMinisterUI implements Serializable {
	private static final long serialVersionUID = 3722412688383507139L;
	...
	protected VerticalLayout getLayout() {
		...
		allNamesComboBox.addFocusListener(new FocusListener() {
			...
			public void focus(FocusEvent event) {
				...
				ArrayList<String> allNames = CommonsHandler.getAllNamesByType("minister");
		...
		CommonsUI.disableComponent(nameTextField, addressNumTextField, addressFreeTextField, phoneTextField,
				...
				eccEducationTextField, jobTextField, coursesTextField, skillsTextField, notesTextField);
		...
		submitButton.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				int result = RequestHandler.handleUpdateRequest("updateMinister", requestData);
				...
				if (result == EMapper.ECODE_SUCCESS) {
					CommonsUI.clearComponentValue(idTextField, nameTextField, addressNumTextField,
							...
							emailTextField, educationTextField, eccEducationTextField, jobTextField,
					...
					CommonsUI.disableComponent(nameTextField, addressNumTextField, addressFreeTextField,
							...
							educationTextField, eccEducationTextField, jobTextField, coursesTextField,
			...
			public void buttonClick(ClickEvent event) {
				...
				confirmButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						int result = RequestHandler.handleUpdateRequest("deleteMinister", requestData);
		...
		allNamesComboBox.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if (event.getProperty().getValue() != null) {
					...
					final String ministerName = String.valueOf(event.getProperty().getValue());
					final SimpleDateFormat dateFormatter = new SimpleDateFormat("dd-MM-yyyy");

					HashMap<String, String> requestData = new HashMap<String, String>();
					requestData.put("ministerName", ministerName);

					HashMap<String, String> result = RequestHandler.handleQueryRequest("getMinisterData",
							requestData);
					...
					jobTextField.setValue(result.get("job"));
