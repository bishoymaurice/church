...
class SearchFatherUI implements Serializable {

	private static final long serialVersionUID = -1492580933579728993L;
	...
	protected VerticalLayout getLayout() {
		...
		GridLayout searchItemsLayout = new GridLayout(5, 5);
		...
		submitButton.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				ArrayList<ArrayList<Object>> searchResult = RequestHandler.handle2DQueryRequest(
						"searchFather", requestData, selectData);
